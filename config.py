...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7615182982:AAG-kvXTMjtHH9uo_XMfiwHkrIzmfuaztsk") 
    ...
    START_PIC   = os.environ.get("START_PIC", "https://wall.alphacoders.com/big.php?i=1299888")
